...
1. **Portfolio only**
   - User: `¿Cuál es el avance del proyecto DEMO-PROJ-001?`
   - Expected route: Portfolio.
   - Expected evidence: DEMO-PROJ-001 demo record.

2. **Contextual follow-up**
   - User: `¿Cuál es su próximo hito y qué dependencias tiene?`
   - Context: `project_id=DEMO-PROJ-001`.
   - Expected route: Portfolio.

3. **Legal**
   - User: `¿Qué riesgo contractual puede afectar al proyecto DEMO-PROJ-001?`
   - Expected route: Legal + Portfolio when the wording contains both domains.
   - Legal evidence: DEMO-LEGAL-001.

4. **Executive WOW moment**
   - User: `¿Cuál es el avance del proyecto DEMO-PROJ-001 y qué riesgos tiene su contrato?`
